  ...
  return (
    <nav className="vms-navbar">
      <div className="vms-nav-content">
        <div className="vms-logo-section" onClick={() => navigate("/")} style={{ cursor: "pointer" }}>
          <div className="vms-logo-icon-box">
            <Shield size={20} />
          </div>
          <span className="vms-brand-name">
            Visitor<span className="vms-text-blue">MS</span>
          </span>
          <span className="vms-role-badge">{roleLabels[role]}</span>
        </div>
